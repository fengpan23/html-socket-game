...
/***/ function(module, exports, __webpack_require__) {
	...
	Application.loadUtils = function() {
	    ...
	    this.set('Util', __webpack_require__(4)(this.get('UTIL_PATH') + '/index.js')(this), true);
	};
	/**
	 * 加载Components,挂载到Application.Component下
	 */
	Application.loadComponents = function(path) {
	    this.set('Component', __webpack_require__(4)(path + '/index.js')(this), true);
	    this.setUpModels();
	    this.setUpViews();
	};
	/**
	...
	Application.loadViews = function(path) {
	    this.set('View', __webpack_require__(4)(path + '/index.js')(this), true);
	};
	/**
	...
	Application.loadModels = function(path) {
	    this.set('Model', __webpack_require__(4)(path + '/index.js')(this), true);
	};
	//Abandoned
